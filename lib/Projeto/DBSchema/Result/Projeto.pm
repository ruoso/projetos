...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gwiwElpXeSEgpj/IvZfX4A


# You can replace this text with custom content, and it will be preserved on regeneration
use overload '""' => sub {$_[0]->id}, fallback => 1;
__PACKAGE__->utf8_columns(qw/projeto_id data_inicio data_fim nome gerente_id coordenacao_id valor status/);
