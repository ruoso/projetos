...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{PROJETO_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{PROJETO_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
projeto_server.pl - Catalyst Testserver

=head1 SYNOPSIS

projeto_server.pl [options]
