...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{PROJETOS_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{PROJETOS_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
projetos_server.pl - Catalyst Testserver

=head1 SYNOPSIS

projetos_server.pl [options]
